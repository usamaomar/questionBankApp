...
class AppStateNotifier extends ChangeNotifier {
  ...
  QuestionBankAuthUser? initialUser;
  QuestionBankAuthUser? user;
  ...
  void update(QuestionBankAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'CreatAccountPage',
          path: '/creatAccountPage',
          builder: (context, params) => const CreatAccountPageWidget(),
        ),
        FFRoute(
          name: 'HomePage',
          path: '/homePage',
        ...
        FFRoute(
          ...
          path: '/packagePage',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'PackagePage')
              : const PackagePageWidget(),
        ),
        FFRoute(
          name: 'SideMenuPage',
          path: '/sideMenuPage',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'SideMenuPage')
              : const SideMenuPageWidget(),
        ),
        FFRoute(
          name: 'EditSettingsPage',
          path: '/editSettingsPage',
          builder: (context, params) => const EditSettingsPageWidget(),
        ),
        FFRoute(
          name: 'AboutAppPage',
          path: '/aboutAppPage',
        ...
        FFRoute(
          ...
          path: '/examResultsPage',
          builder: (context, params) => const ExamResultsPageWidget(),
        ),
        FFRoute(
          name: 'ExamsPage',
          path: '/examsPage',
          builder: (context, params) => const ExamsPageWidget(),
        ),
        FFRoute(
          name: 'StartExamPage',
          path: '/startExamPage',
        ...
        FFRoute(
          ...
          path: '/countryCodePage',
          builder: (context, params) => const CountryCodePageWidget(),
        )
