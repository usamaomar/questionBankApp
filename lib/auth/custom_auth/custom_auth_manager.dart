...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    questionBankAuthUserSubject.add(
      QuestionBankAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<QuestionBankAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  QuestionBankAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = QuestionBankAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    questionBankAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
QuestionBankAuthUser? currentUser;
